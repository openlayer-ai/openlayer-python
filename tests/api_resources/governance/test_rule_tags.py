...
class TestRuleTags:
    ...
    def test_method_list(self, client: Openlayer) -> None:
        rule_tag = client.governance.rule_tags.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(RuleTagListResponse, rule_tag, path=["response"])
    ...
    def test_raw_response_list(self, client: Openlayer) -> None:
        response = client.governance.rule_tags.with_raw_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        rule_tag = response.parse()
        assert_matches_type(RuleTagListResponse, rule_tag, path=["response"])

    @parametrize
    def test_streaming_response_list(self, client: Openlayer) -> None:
        with client.governance.rule_tags.with_streaming_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_list(self, client: Openlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.governance.rule_tags.with_raw_response.list(
                workspace_id="",
            )


class TestAsyncRuleTags:
    ...
    async def test_method_list(self, async_client: AsyncOpenlayer) -> None:
        rule_tag = await async_client.governance.rule_tags.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(RuleTagListResponse, rule_tag, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOpenlayer) -> None:
        response = await async_client.governance.rule_tags.with_raw_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        rule_tag = await response.parse()
        assert_matches_type(RuleTagListResponse, rule_tag, path=["response"])

    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncOpenlayer) -> None:
        async with async_client.governance.rule_tags.with_streaming_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncOpenlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.governance.rule_tags.with_raw_response.list(
                workspace_id="",
            )
