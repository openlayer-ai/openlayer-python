...
class TestSubsections:
    ...
    def test_method_list_rules(self, client: Openlayer) -> None:
        subsection = client.governance.frameworks.subsections.list_rules(
            subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SubsectionListRulesResponse, subsection, path=["response"])
    ...
    def test_raw_response_list_rules(self, client: Openlayer) -> None:
        response = client.governance.frameworks.subsections.with_raw_response.list_rules(
            subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        ...
        subsection = response.parse()
        assert_matches_type(SubsectionListRulesResponse, subsection, path=["response"])

    @parametrize
    def test_streaming_response_list_rules(self, client: Openlayer) -> None:
        with client.governance.frameworks.subsections.with_streaming_response.list_rules(
            subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_list_rules(self, client: Openlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `framework_id` but received ''"):
            client.governance.frameworks.subsections.with_raw_response.list_rules(
                subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                framework_id="",
            )

        with pytest.raises(ValueError, match=r"Expected a non-empty value for `subsection_id` but received ''"):
            client.governance.frameworks.subsections.with_raw_response.list_rules(
                subsection_id="",
                framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            )
...
class TestAsyncSubsections:
    ...
    async def test_method_list_rules(self, async_client: AsyncOpenlayer) -> None:
        subsection = await async_client.governance.frameworks.subsections.list_rules(
            subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SubsectionListRulesResponse, subsection, path=["response"])
    ...
    async def test_raw_response_list_rules(self, async_client: AsyncOpenlayer) -> None:
        response = await async_client.governance.frameworks.subsections.with_raw_response.list_rules(
            subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        subsection = await response.parse()
        assert_matches_type(SubsectionListRulesResponse, subsection, path=["response"])

    @parametrize
    async def test_streaming_response_list_rules(self, async_client: AsyncOpenlayer) -> None:
        async with async_client.governance.frameworks.subsections.with_streaming_response.list_rules(
            subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list_rules(self, async_client: AsyncOpenlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `framework_id` but received ''"):
            await async_client.governance.frameworks.subsections.with_raw_response.list_rules(
                subsection_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                framework_id="",
            )
