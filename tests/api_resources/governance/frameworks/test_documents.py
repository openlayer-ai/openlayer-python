...
from openlayer.types.governance.frameworks import DocumentListResponse, DocumentRetrieveResponse
...
class TestDocuments:
    ...
    def test_method_retrieve(self, client: Openlayer) -> None:
        document = client.governance.frameworks.documents.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Openlayer) -> None:
        response = client.governance.frameworks.documents.with_raw_response.retrieve(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: Openlayer) -> None:
        with client.governance.frameworks.documents.with_streaming_response.retrieve(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Openlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `framework_id` but received ''"):
            client.governance.frameworks.documents.with_raw_response.retrieve(
                document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                framework_id="",
            )
    ...
    def test_method_list(self, client: Openlayer) -> None:
        document = client.governance.frameworks.documents.list(
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_list(self, client: Openlayer) -> None:
        response = client.governance.frameworks.documents.with_raw_response.list(
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: Openlayer) -> None:
        with client.governance.frameworks.documents.with_streaming_response.list(
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Openlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `framework_id` but received ''"):
            client.governance.frameworks.documents.with_raw_response.list(
                framework_id="",
            )
...
class TestAsyncDocuments:
    ...
    async def test_method_retrieve(self, async_client: AsyncOpenlayer) -> None:
        document = await async_client.governance.frameworks.documents.retrieve(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(DocumentRetrieveResponse, document, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncOpenlayer) -> None:
        response = await async_client.governance.frameworks.documents.with_raw_response.retrieve(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncOpenlayer) -> None:
        async with async_client.governance.frameworks.documents.with_streaming_response.retrieve(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncOpenlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `framework_id` but received ''"):
            await async_client.governance.frameworks.documents.with_raw_response.retrieve(
                document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                framework_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncOpenlayer) -> None:
        document = await async_client.governance.frameworks.documents.list(
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(DocumentListResponse, document, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOpenlayer) -> None:
        response = await async_client.governance.frameworks.documents.with_raw_response.list(
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncOpenlayer) -> None:
        async with async_client.governance.frameworks.documents.with_streaming_response.list(
            framework_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncOpenlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `framework_id` but received ''"):
            await async_client.governance.frameworks.documents.with_raw_response.list(
                framework_id="",
            )
