...
class TestInvites:
    ...
    def test_method_create(self, client: Openlayer) -> None:
        invite = client.workspaces.invites.create(
    ...
    def test_raw_response_create(self, client: Openlayer) -> None:
        response = client.workspaces.invites.with_raw_response.create(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create(self, client: Openlayer) -> None:
        with client.workspaces.invites.with_streaming_response.create(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_create(self, client: Openlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.workspaces.invites.with_raw_response.create(
                workspace_id="",
            )

    @parametrize
    def test_method_list(self, client: Openlayer) -> None:
        invite = client.workspaces.invites.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_list(self, client: Openlayer) -> None:
        response = client.workspaces.invites.with_raw_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: Openlayer) -> None:
        with client.workspaces.invites.with_streaming_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Openlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.workspaces.invites.with_raw_response.list(
                workspace_id="",
            )
...
class TestAsyncInvites:
    ...
    async def test_method_create(self, async_client: AsyncOpenlayer) -> None:
        invite = await async_client.workspaces.invites.create(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(InviteCreateResponse, invite, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncOpenlayer) -> None:
        response = await async_client.workspaces.invites.with_raw_response.create(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncOpenlayer) -> None:
        async with async_client.workspaces.invites.with_streaming_response.create(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncOpenlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.workspaces.invites.with_raw_response.create(
                workspace_id="",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncOpenlayer) -> None:
        invite = await async_client.workspaces.invites.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(InviteListResponse, invite, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncOpenlayer) -> None:
        response = await async_client.workspaces.invites.with_raw_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncOpenlayer) -> None:
        async with async_client.workspaces.invites.with_streaming_response.list(
            workspace_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncOpenlayer) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.workspaces.invites.with_raw_response.list(
                workspace_id="",
            )
