...
* **closes OPEN-11851:** expose update project endpoint ([e55b71f](https://github.com/openlayer-ai/openlayer-python/commit/e55b71f493d1b8a568b0c2334b088e15232b9aea))
...
* **closes OPEN-10366:** update Jupyter notebook examples with init-based tracer ([05fc456](https://github.com/openlayer-ai/openlayer-python/commit/05fc45604dd559a81c7afcffb00e97880e5afd1e))
...
* **context fix:** fixed sessions and users for langchain callback ([#617](https://github.com/openlayer-ai/openlayer-python/issues/617)) ([932c5af](https://github.com/openlayer-ai/openlayer-python/commit/932c5af8775a50747dd8904d6cfc4df7f625f8cc))
...
* update mock server docs ([e5d4a3d](https://github.com/openlayer-ai/openlayer-python/commit/e5d4a3d7be61a4171fb29deef6e2d8040cfce910))

## 0.17.5 (2026-02-17)

Full Changelog: [v0.17.4...v0.17.5](https://github.com/openlayer-ai/openlayer-python/compare/v0.17.4...v0.17.5)

### Bug Fixes

* **open-9027:** azure openai tracer fix for chunks ([5fa4e0d](https://github.com/openlayer-ai/openlayer-python/commit/5fa4e0d108011111b6d2abcbe2c759c933ef7571))
...
* **closes OPEN-8768:** langChain callback handler not using sessions and users ([e629fd3](https://github.com/openlayer-ai/openlayer-python/commit/e629fd317b02818c2440774ceeb91438447c9f1f))


### Chores

* **ci:** upgrade `actions/github-script` ([d798acb](https://github.com/openlayer-ai/openlayer-python/commit/d798acb6894849bf888f318ab15220d611855df4))

## 0.15.1 (2026-01-17)

Full Changelog: [v0.15.0...v0.15.1](https://github.com/openlayer-ai/openlayer-python/compare/v0.15.0...v0.15.1)

### Chores

* **internal:** update `actions/checkout` version ([b141555](https://github.com/openlayer-ai/openlayer-python/commit/b1415557d5ea5e698d5c4e8df35d9fcf7af976bf))
...
* **closes OPEN-8532:** expose 'tests/{id}/results' endpoint ([208192c](https://github.com/openlayer-ai/openlayer-python/commit/208192c0d5ffa9e1b7eddc992762dea377c21dd1))

## 0.13.1 (2026-01-08)

Full Changelog: [v0.13.0...v0.13.1](https://github.com/openlayer-ai/openlayer-python/compare/v0.13.0...v0.13.1)

### Chores

* **closes OPEN-8644:** address warnings on Stainless studio ([662f735](https://github.com/openlayer-ai/openlayer-python/commit/662f735c40b30f2d75c3889da817b9375a26e3ad))
* remove _meta ([0b2c45b](https://github.com/openlayer-ai/openlayer-python/commit/0b2c45b288747d86e1a0c0036d356ba8d12c524d))
...
* **closes OPEN-8569:** handle missing active trace and improve error logging in LiteLLM integration ([#569](https://github.com/openlayer-ai/openlayer-python/issues/569)) ([d35f78c](https://github.com/openlayer-ai/openlayer-python/commit/d35f78c03328cc43630352d39e127cbb57dcd6f8))
...
* **closes OPEN-8244:** Adds Gemini API client tracing ([8227c31](https://github.com/openlayer-ai/openlayer-python/commit/8227c3104316fda400d612c4895b84e9e8a6bd12))
...
* add Openlayer's client custom settings for tracer ([#536](https://github.com/openlayer-ai/openlayer-python/issues/536)) ([aca3dab](https://github.com/openlayer-ai/openlayer-python/commit/aca3dab1234bf1d223884ca66c80769cef6e1786))
...
* completes OPEN-7314 Process input/output of root step of LangGraph graphs ([9cad000](https://github.com/openlayer-ai/openlayer-python/commit/9cad000f3d201dde4641eba6b3ae49ecf0db5496))
...
* introduce new step types ([9ef8390](https://github.com/openlayer-ai/openlayer-python/commit/9ef8390fdeafb3f2a0bf9e278a0aaf606185584d))

## 0.2.0-alpha.87 (2025-09-04)

Full Changelog: [v0.2.0-alpha.86...v0.2.0-alpha.87](https://github.com/openlayer-ai/openlayer-python/compare/v0.2.0-alpha.86...v0.2.0-alpha.87)

### Features

* improve future compat with pydantic v3 ([88a15df](https://github.com/openlayer-ai/openlayer-python/commit/88a15df047bc0b4ddf388dfc18693f363cc11c48))
* **types:** replace List[str] with SequenceNotStr in params ([8838b80](https://github.com/openlayer-ai/openlayer-python/commit/8838b8041ae034bfe7c59a5cd259ffaba4138434))
...
* recognize Azure as a provider in the LangChain callback handler ([3509bc0](https://github.com/openlayer-ai/openlayer-python/commit/3509bc08bb49eaf859582627c8c85c8ce77eda6a))
