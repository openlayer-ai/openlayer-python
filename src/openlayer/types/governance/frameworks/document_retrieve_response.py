...
__all__ = ["DocumentRetrieveResponse", "Section", "SectionRule", "SectionSubsection", "SectionSubsectionRule"]
...
class SectionSubsectionRule(BaseModel):
    id: str
    """The rule id."""
...
class SectionSubsection(BaseModel):
    ...
    rules: Optional[List[SectionSubsectionRule]] = None
...
class Section(BaseModel):
    ...
    subsections: Optional[List[SectionSubsection]] = None
