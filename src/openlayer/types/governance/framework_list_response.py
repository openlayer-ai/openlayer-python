...
__all__ = [
    ...
    "ItemAvatar",
    "ItemProjectSelector",
    "ItemProjectSelectorMatch",
    "ItemRuleStats",
    "ItemRuleStatsProjectCompletion",
    "ItemRuleStatsRuleResults",
]


class ItemAvatar(BaseModel):
...
class ItemProjectSelectorMatch(BaseModel):
...
class ItemProjectSelector(BaseModel):
    ...
    match: Optional[List[ItemProjectSelectorMatch]] = None
    """Match criteria, ANDed together."""


class ItemRuleStatsProjectCompletion(BaseModel):
    """
...
class ItemRuleStatsRuleResults(BaseModel):
    """
...
class ItemRuleStats(BaseModel):
    ...
    project_completion: ItemRuleStatsProjectCompletion = FieldInfo(alias="projectCompletion")
    """
    ...
    rule_results: ItemRuleStatsRuleResults = FieldInfo(alias="ruleResults")
    """
...
class Item(BaseModel):
    ...
    avatar: Optional[ItemAvatar] = None
    """The icon shown for the framework."""
    ...
    rule_stats: Optional[ItemRuleStats] = FieldInfo(alias="ruleStats", default=None)
    """Compliance roll-up for the framework.
