...
class FrameworkAvatar(BaseModel):
...
class Framework(BaseModel):
    ...
    avatar: Optional[FrameworkAvatar] = None
    """The icon shown for the framework."""
...
class ResultBlockedBy(BaseModel):
...
class ResultBlocking(BaseModel):
    id: Optional[str] = None
...
class Result(BaseModel):
    ...
    blocked_by: Optional[List[ResultBlockedBy]] = FieldInfo(alias="blockedBy", default=None)
    """Rule results that must pass before this one can be satisfied."""

    blocking: Optional[List[ResultBlocking]] = None
...
class RuleUpdateResponse(BaseModel):
    ...
    results_summary: Optional[ResultsSummary] = FieldInfo(alias="resultsSummary", default=None)
    """
