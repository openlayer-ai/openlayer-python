...
__all__ = ["RuleResultRetrieveResponse", "BlockedBy", "Blocking"]
...
class RuleResultRetrieveResponse(BaseModel):
    id: str
    """The rule result id."""
    ...
    blocked_by: Optional[List[BlockedBy]] = FieldInfo(alias="blockedBy", default=None)
    """Rule results that must pass before this one can be satisfied."""

    blocking: Optional[List[Blocking]] = None
