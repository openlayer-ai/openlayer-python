...
__all__ = [
    ...
    "LastUnskippedResult",
    "LastUnskippedResultExpectedValue",
    "LastUnskippedResultGoal",
    "LastUnskippedResultGoalThreshold",
    "LastUnskippedResultGoalThresholdInsightParameter",
    "LastUnskippedResultRowsBody",
    "LastUnskippedResultRowsBodyColumnFilter",
    "LastUnskippedResultRowsBodyColumnFilterSetColumnFilter",
    "LastUnskippedResultRowsBodyColumnFilterNumericColumnFilter",
    "LastUnskippedResultRowsBodyColumnFilterStringColumnFilter",
]
...
class LastUnskippedResultExpectedValue(BaseModel):
    lower_threshold: Optional[float] = FieldInfo(alias="lowerThreshold", default=None)
    """the lower threshold for the expected value"""
...
class LastUnskippedResultGoalThresholdInsightParameter(BaseModel):
    name: str
    """The name of the insight filter."""
...
class LastUnskippedResultGoalThreshold(BaseModel):
    insight_name: Optional[
        Literal[
            "characterLength",
            "classImbalance",
    ...
    insight_parameters: Optional[List[LastUnskippedResultGoalThresholdInsightParameter]] = FieldInfo(
        alias="insightParameters", default=None
    )
    """The insight parameters.
...
class LastUnskippedResultGoal(BaseModel):
    id: str
    """The test id."""
    ...
    thresholds: List[LastUnskippedResultGoalThreshold]
...
class LastUnskippedResultRowsBodyColumnFilterSetColumnFilter(BaseModel):
    measurement: str
    """The name of the column."""
...
class LastUnskippedResultRowsBodyColumnFilterNumericColumnFilter(BaseModel):
    measurement: str
    """The name of the column."""
...
class LastUnskippedResultRowsBodyColumnFilterStringColumnFilter(BaseModel):
    measurement: str
    """The name of the column."""
...
LastUnskippedResultRowsBodyColumnFilter: TypeAlias = Union[
    LastUnskippedResultRowsBodyColumnFilterSetColumnFilter,
    LastUnskippedResultRowsBodyColumnFilterNumericColumnFilter,
    LastUnskippedResultRowsBodyColumnFilterStringColumnFilter,
]
...
class LastUnskippedResultRowsBody(BaseModel):
    """The body of the rows request."""

    column_filters: Optional[List[LastUnskippedResultRowsBodyColumnFilter]] = FieldInfo(
        alias="columnFilters", default=None
    )
...
class LastUnskippedResult(BaseModel):
    id: str
    """Project version (commit) id."""
    ...
    expected_values: Optional[List[LastUnskippedResultExpectedValue]] = FieldInfo(alias="expectedValues", default=None)

    goal: Optional[LastUnskippedResultGoal] = None
    ...
    rows_body: Optional[LastUnskippedResultRowsBody] = FieldInfo(alias="rowsBody", default=None)
    """The body of the rows request."""


class TestListResultsResponse(BaseModel):
    __test__ = False
    items: List[Item]

    last_unskipped_result: Optional[LastUnskippedResult] = FieldInfo(alias="lastUnskippedResult", default=None)
